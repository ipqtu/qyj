...
class Controller_AvatarFlashUpload extends Controller_Base{
    ...
    public function showuploadAction() {
        ...
        $uc_avatarflash = $this->config->uc_api.'/images/member/camera.swf?nt=1&inajax=1&input='.$uc_input.'&agent='.md5($_SERVER['HTTP_USER_AGENT']).'&ucapi='.urlencode(SITE_URL.'/member/avatar.html').'&uploadSize='.$this->config->uploadsize;
        if( $returnhtml == 1 ) {
